...
var dialog = $.widget( "ui.dialog", {
	...
	open: function() {
		...
		// 7.0.70 custom jquery ui 1.11.2 반영 
		if ( this.overlay ) {
	...
	_createTitlebar: function() {
		...
		this.uiDialogTitlebarClose = $( "<button type='button'></button>" )
			...
			.addClass( "ui-dialog-titlebar-close _cmmDialogClose" ) //custom
	...
	_makeDraggable: function() {
		...
		this.uiDialog.draggable({
			cancel: ".ui-dialog-content, .ui-dialog-titlebar-close _cmmDialogClose", //custom
